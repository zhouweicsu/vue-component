...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/zhouwei3-xy/vue-component/src/area.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _areacode = __webpack_require__(12);
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        syncCity: function syncCity(ccity, event) {
	            var me = this;
	            var bool = event ? event.target.checked : true;
	            me.areacode.forEasavech(function (area) {
	    ...
	    events: {
	        ...
	        cancleEvent: function cancleEvent() {}
	    }
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/zhouwei3-xy/vue-component/src/_dialog.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
