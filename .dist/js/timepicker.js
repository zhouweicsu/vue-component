	    ...
	    methods: {
	        ...
	        selectDay: function selectDay(day, bool) {
	            ...
	            this.times[day].map(function (hour, hi) {
	                return _this3.times[day].$set(hi, _this3.fbdArr[day][hi] ? 0 : +bool);
	            });
	        },
	        selectHour: function selectHour(hour) {
	            ...
	            //选择整个时间点
	            var isChecked = this.isHourAllChecked[hour] == 7 ? 0 : 1;
	            this.times.map(function (day, di) {
	                return day.$set(hour, _this4.fbdArr[di][hour] ? 0 : isChecked);
	            });
	        },
